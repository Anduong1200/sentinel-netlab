...
class TestBufferManager:
    ...
    def buffer(self, temp_dir):
        return BufferManager(
            max_memory_items=100, storage_path=temp_dir, max_disk_mb=10
        )
    ...
    def test_ring_buffer_overflow_drop_oldest(self, temp_dir):
        ...
        buffer = BufferManager(
            max_memory_items=5, storage_path=temp_dir, drop_policy="oldest"
        )
    ...
    def test_spill_to_disk_and_replay(self, temp_dir):
        ...
        buffer = BufferManager(max_memory_items=100, storage_path=temp_dir)
