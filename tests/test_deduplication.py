...
os.environ["CONTROLLER_SECRET_KEY"] = "test-secret"
os.environ["CONTROLLER_HMAC_SECRET"] = "test-hmac"
os.environ["DATABASE_URL"] = "sqlite:///:memory:"

from controller.api_server import app
from controller.api.models import Telemetry, IngestJob, Token
...
class TestDeduplication(unittest.TestCase):
    ...
    def test_deduplication_batch_id(self, mock_enqueue, mock_verify_ts, mock_verify_hmac):
        ...
        data = resp2.json
        self.assertEqual(data["ack_id"], "ack-old-123")
