...
**Câu 8: (Nền tảng) Cảm biến (Sensor) hoạt động ở chế độ mạng nào để thu thập dữ liệu? Nó khác gì với chế độ Promiscuous?**
...
**Câu 9: (Nền tảng) Management Frames (Khung quản lý 802.11) là gì? Kể tên một vài loại frame mà dự án của em tập trung phân tích?**
...
**Câu 10: Quá trình (Pipeline) xử lý dữ liệu của Sensor diễn ra như thế nào?**
**Trả lời:** Gồm 4 bước:
...
**Câu 11: Tính năng "Channel Hopping" trong Sensor có tác dụng gì?**
...
**Câu 12: (Khó) Làm thế nào hệ thống đảm bảo không bị quá tải bộ nhớ RAM khi phải xử lý hàng nghìn gói tin mỗi giây?**
**Trả lời:**
...
**Câu 13: (Khó) Hệ thống giải quyết vấn đề Sensor bị mất mạng tạm thời (Network Cut) như thế nào?**
...
## Phần 3: Thuật toán phát hiện tấn công, Exploit Chains & Wardriving

**Câu 14: (Nền tảng) Tấn công Evil Twin là gì? Tại sao nó nguy hiểm?**
...
**Câu 15: Cuộc tấn công Deauth Flood (Từ chối dịch vụ WiFi) được hệ thống phát hiện dựa trên cơ chế nào?**
...
**Câu 16: Làm sao hệ thống phát hiện ra điểm phát sóng giả mạo (Evil Twin)?**
...
**Câu 17: Việc "Temporal confirmation" (Xác nhận theo thời gian) trong Evil Twin Detector có ý nghĩa gì?**
...
**Câu 18: Hệ thống làm thế nào để tránh việc cảnh báo liên tục một cuộc tấn công đang diễn ra (Alert Spam)?**
...
**Câu 19: Tại sao trong thuật toán phát hiện, cấu trúc dữ liệu Set (tập hợp) và Dictionary (bảng băm) lại được sử dụng nhiều (ví dụ O(1) lookups)?**
...
**Câu 20: (Khó) Khái niệm "Exploit Chain" trong dự án là gì? Nó giúp phát hiện điều gì mà các thuật toán đơn lẻ không làm được?**
...
**Câu 21: (Khó) Cuộc tấn công KARMA/Pineapple (Karma Detector) hoạt động dựa trên cơ chế bắt gói tin nào?**
...
**Câu 22: (Tính năng mới) Trong quá trình hoạt động, hệ thống sử dụng "Wardriving" (Ví dụ `wardrive_session.json`) nhằm mục đích gì?**
**Trả lời:** Wardriving được dùng trong "Assessment Mode" (Chế độ đánh giá) để dò quét chủ động các mạng WiFi xung quanh khu vực vật lý. Dữ liệu bao gồm BSSID, SSID, RSSI, Channel và Chuẩn bảo mật (Security). Nó giúp người quản trị lập bản đồ mạng hiện có (Baseline), từ đó phát hiện các AP trái phép (Rogue AP) xuất hiện ngoài danh sách `unique_networks` hợp lệ.

---

## Phần 4: Backend Controller & API

**Câu 23: Tại sao API Server của Controller (Flask) không nhận trực tiếp Raw PCAP mà lại nhận JSON Telemetry?**
...
**Câu 24: An toàn thông tin giữa Sensor và Controller được đảm bảo như thế nào?**
...
**Câu 25: Middleware trong Flask API đóng vai trò gì trong hệ thống này?**
...
**Câu 26: Mô hình Machine Learning trong dự án sử dụng kiến trúc mạng nơ-ron nào và tại sao?**
...
**Câu 27: Làm sao Autoencoder phát hiện được sự bất thường (Anomaly)?**
...
**Câu 28: ML Autoencoder ở đây là học có giám sát (Supervised) hay không giám sát (Unsupervised)? Lý do chọn?**
...
## Phần 6: Vận hành, Thực tế & Bảo mật dự án

**Câu 29: (Nền tảng) Dự án tuân thủ quyền riêng tư (Privacy) của người dùng mạng WiFi như thế nào?**
...
**Câu 30: (Nền tảng) "Lab Mode" và "Production Mode" khác nhau thế nào trong dự án này?**
**Trả lời:**
...
**Câu 31: (Khó) Trong hệ thống cấu hình (`sensor/config.py`), dự án sử dụng mô hình "Fail-Fast Secret" là gì và tại sao nó quan trọng?**
...
**Câu 32: (Khó) Nếu một kẻ tấn công gửi ngập lụt (flood) các cảnh báo giả mạo lên API của Controller nhằm làm sập Database, em xử lý tình huống đó ở Backend ra sao?**
...
**Câu 33: (Khó) Khó khăn lớn nhất trong việc kiểm thử (Testing) module Sensor thu thập gói tin không dây (Wi-Fi 802.11) là gì và dự án giải quyết như thế nào?**
...
**Câu 34: (Khó) Gói tin khi vận chuyển từ Sensor lên Controller (`sensor/transport.py`) được cấu trúc và bảo vệ như thế nào?**
**Trả lời:**
