...
class JammingStats:
    ...
    # ⚡ Bolt Optimization: Using `deque(maxlen=100)` instead of `list` to prevent O(N) memory
    # reallocations when appending elements past the length limit, reducing overhead.
